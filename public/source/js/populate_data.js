...
const populateData = async () => {
    ...
    !localStorage.getItem("todos") ? localStorage.setItem("todos", JSON.stringify([])) : null;
    !localStorage.getItem("courses") ? localStorage.setItem("courses", JSON.stringify([{ name: "Introduction to DevOps Practices:", chapters: 4 }, { name: "Introduction to Agile Development:", chapters: 5 }])) : null;
